...
if($arParams["USER_TYPE"] == "worker" || $arParams["USER_TYPE"] == "admin"){
	...
	$arUserShowRights["type"] = "custom";
	$arUserShowRights["show"] = "Y";
	$arUserShowRights["value"] = "<input type=\"text\" name=\"".$arUserShowRights["id"]."\" value=\"1\">";
	$arUserShowRights["not_show_not_modify"] = "Y";
