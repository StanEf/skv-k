...
{
	$this->addExternalJs($arResult['CAPTCHA']['JS_LINK']);
}
			...
			<div class="col-md-12 col-sm-12">
				<div class="crm-webform-block crm-webform-default">
					...
					<div class="crm-webform-body">
						<form class="crm-webform-form-container" id="bxform" method="POST" enctype="multipart/form-data" action="<?=$APPLICATION->GetCurPageParam()?>">
							<?
										...
										switch($field['type'])
										{
											...
											case 'phone':
												...
												if(in_array(LANGUAGE_ID, array('ru', 'ua')))
												{
													...
													$input .= '<input value="' . $inputValue . '" class="crm-webform-input crm-webform-input-phone" autocomplete="off" type="tel" placeholder="' . $inputPlaceholder . '">';
							...
							<fieldset class="crm-webform-fieldset-footer">
								<div class="row">
									...
									<?if(!empty($arResult['FORM']['LICENCE_TEXT'])):?>
										...
										<div class="crm-webform-group">
											<div class="crm-webform-label-content">
												<label class="crm-webform-checkbox-container crm-webform-checkbox-products">
													<input id="licence_accept" class="crm-webform-checkbox crm-webform-input" type="checkbox" value="Y">
													<i></i>
													<span class="crm-webform-checkbox-name ">
														<a id="licence_show_button"><?=htmlspecialcharsbx($arResult['FORM']['LICENCE_BUTTON_CAPTION'])?></a>
													</span>
												</label>
											</div>
										</div>
		...
		<div class="crm-webform-popup-container">
			...
			<div class="crm-webform-popup-content" id="RESULT_MESSAGE_CONTENT">
				...
				<div class="crm-webform-popup-licence">
					<textarea disabled class="crm-webform-popup-licence-text"><?=htmlspecialcharsbx($arResult['FORM']['LICENCE_TEXT'])?></textarea>
				</div>
			</div>
		...
		BX.CrmWebForm = new CrmWebForm(<?=CUtil::PhpToJSObject(
			array(
				...
				'mess' => array(
					...
					'licencePre' => Loc::getMessage('CRM_WEBFORM_FILL_LICENCE_PROMPT')
				)
			)
		)?>);
	});
