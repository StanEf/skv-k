...
if($arResult['PERM_CONFIG'])
{
	...
	$items['tab_content_integration']['EXTERNAL_SALE']['URL'] = $siteDir.'/crm/configs/external_sale/';
...
if($arResult['IS_ACCESS_ENABLED'])
{
	...
	$items['tab_content_work_with_mail']['MAIL_TRACKER']['URL'] = $siteDir.'/company/personal/mail/?page=home';
