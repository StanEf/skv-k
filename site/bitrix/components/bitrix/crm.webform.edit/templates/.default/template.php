...
<?$this->SetViewTarget('pagetitle', 5);?>
	<a href="<?=htmlspecialcharsbx($arResult['PATH_TO_WEB_FORM_LIST'])?>" class="crm-webform-edit-list-back"><?=Loc::getMessage('CRM_WEBFORM_EDIT_BACK_TO_LIST1')?></a>
<?$this->EndViewTarget();?>
...
<div class="crm-webform-edit-wrapper">
	...
	<div class="task-info">
		<div class="task-info-panel">
			<div class="task-info-panel-title">
				<input name="NAME" value="<?=htmlspecialcharsbx($arResult['FORM']['NAME'])?>" type="text" placeholder="<?=Loc::getMessage('CRM_WEBFORM_EDIT_FORM_NAME')?>">
			</div>
		</div>
			...
			<div id="FORM_BUTTON_CONTAINER" class="crm-webform-edit-left-field-button-container">
				...
				<div class="crm-webform-edit-left-field-colorpick">
					<span class="crm-webform-edit-left-field-colorpick-text-container">
						<input size="7" id="BUTTON_COLOR_BG" data-web-form-color-picker="" type="hidden" name="BUTTON_COLOR_BG" value="<?=$arResult['FORM']['BUTTON_COLOR_BG']?>">
					...
					<span class="crm-webform-edit-left-field-colorpick-text-container">
						<input size="7" id="BUTTON_COLOR_FONT" data-web-form-color-picker="" type="hidden" name="BUTTON_COLOR_FONT" value="<?=$arResult['FORM']['BUTTON_COLOR_FONT']?>">
	...
	?>
		<label for="USE_PRESET_FIELDS" class="task-field-label task-field-label-repeat">
			<input id="USE_PRESET_FIELDS" name="USE_PRESET_FIELDS" onclick="BX.toggleClass(BX('PRESET_FIELDS'), 'crm-webform-edit-animate-show')" value="Y" type="checkbox" <?=($arResult['FORM']['HAS_PRESET_FIELDS'] ? 'checked' : '')?> class="crm-webform-edit-task-options-checkbox">
			<span class="crm-webform-edit-task-options-checkbox-item-container">
				...
				<div id="CRM_WEBFORM_EXTERNAL_ANALYTICS" class="crm-webform-edit-task-options-metric">
					...
					<div data-bx-crm-webform-ext-an="ya" class="<?=($arResult['FORM']['YANDEX_METRIC_ID'] ? 'crm-webform-edit-task-options-metric-exist' : '')?>">
						<div class="crm-webform-edit-task-options-metric-option">
							...
							<span class="crm-webform-edit-task-options-metric-id">
								<input name="YANDEX_METRIC_ID" value="<?=$arResult['FORM']['YANDEX_METRIC_ID']?>"
					...
					<div data-bx-crm-webform-ext-an="ga" class="<?=($arResult['FORM']['GOOGLE_ANALYTICS_ID'] ? 'crm-webform-edit-task-options-metric-exist' : '')?>">
						<div class="crm-webform-edit-task-options-metric-option">
							...
							<span class="crm-webform-edit-task-options-metric-id">
								<input name="GOOGLE_ANALYTICS_ID" value="<?=$arResult['FORM']['GOOGLE_ANALYTICS_ID']?>"
									data-bx-crm-webform-ext-an-val=""
	...
	?>
		<label for="USE_LICENCE" class="task-field-label">
			<input id="USE_LICENCE" name="USE_LICENCE" value="Y" type="checkbox" <?=($arResult['FORM']['LICENCE_TEXT'] ? 'checked' : '')?> class="crm-webform-edit-task-options-checkbox">
			<span class="crm-webform-edit-task-options-checkbox-item-container">
				<span class="crm-webform-edit-task-options-checkbox-item"><?=Loc::getMessage('CRM_WEBFORM_EDIT_LICENCE_TITLE')?></span>
			</span>
		</label>
		<div id="LICENCE_CONTAINER" class="crm-webform-edit-task-options-item-open-settings <?=(htmlspecialcharsbx($arResult['FORM']['LICENCE_TEXT']) ? '' : 'crm-webform-display-none')?>">
			<div class="crm-webform-edit-task-edit-deal-inner">
				<div class="crm-webform-edit-task-edit-deal-license-element">

					<div data-bx-web-form-lbl-cont="">
						<span class="crm-webform-edit-left-field-header-title-container">
							<span data-bx-web-form-lbl-caption="" class="crm-webform-edit-task-edit-deal-license-text"><?=htmlspecialcharsbx($arResult['FORM']['LICENCE_BUTTON_CAPTION'])?></span>
							<span data-bx-web-form-lbl-btn-edit="" class="crm-webform-edit-task-edit-deal-license-icon" title="<?=Loc::getMessage('CRM_WEBFORM_EDIT_INLINE_EDIT')?>"></span>
						</span>
						<span class="crm-webform-edit-task-edit-deal-license-text-edit">
							<input data-bx-web-form-btn-caption="" name="LICENCE_BUTTON_CAPTION" type="text" value="<?=htmlspecialcharsbx($arResult['FORM']['LICENCE_BUTTON_CAPTION'])?>" class="crm-webform-edit-left-inner-field-title-field-item">
				...
				<div class="crm-webform-edit-task-edit-deal-license-input-container">
					<textarea name="LICENCE_TEXT" placeholder="<?=Loc::getMessage('CRM_WEBFORM_EDIT_LICENCE_TEXT_HINT')?>" class="crm-webform-edit-task-edit-deal-license-input"><?=htmlspecialcharsbx($arResult['FORM']['LICENCE_TEXT'])?></textarea>
				</div>
			</div><!--crm-webform-edit-task-edit-deal-stage-->
		</div><!--crm-webform-edit-task-options-item-open-settings-->
	...
	<?if($arResult['FORM']['IS_SYSTEM'] == 'Y'):?>
		<div class="crm-webform-edit-system-warning-cont">
			<span class="crm-webform-edit-system-warning-text">
				<?=Loc::getMessage('CRM_WEBFORM_EDIT_SYSTEM_CANT_COPY')?>
			</span>
		</div>
	<?endif;?>

	<div class="crm-webform-edit-button-container">
		<?if($arResult['PERM_CAN_EDIT']):?>
			<?if($arResult['FORM']['IS_SYSTEM'] != 'Y'):?>
				<button id="CRM_WEBFORM_SUBMIT_BUTTON" type="submit" class="webform-small-button webform-small-button-accept crm-webform-edit-button-save"><?=Loc::getMessage('CRM_WEBFORM_EDIT_BUTTON_SAVE')?></button>
				<button id="CRM_WEBFORM_SUBMIT_APPLY" name="submit_apply" value="Y" type="submit" class="webform-small-button webform-small-button-transparent crm-webform-edit-button-save"><?=Loc::getMessage('CRM_WEBFORM_EDIT_BUTTON_APPLY')?></button>
			<?else:?>
				<span id="CRM_WEBFORM_COPY_BUTTON" class="webform-small-button webform-small-button-accept crm-webform-edit-button-save"><?=Loc::getMessage('CRM_WEBFORM_EDIT_COPY')?></span>
			<?endif;?>
		<?endif;?>
		<a href="<?=htmlspecialcharsbx($arResult['PATH_TO_WEB_FORM_LIST'])?>" class="webform-small-button webform-small-button-transparent crm-webform-edit-button-cancel"><?=Loc::getMessage('CRM_WEBFORM_EDIT_BACK_TO_LIST')?></a>
	</div>
</div>
...
<div style="display: none;">
	...
	<div id="CRM_WEB_FORM_POPUP_SETTINGS">
		<div class="crm-webform-edit-popup-wrapper">
			...
			<!--
			<div class="crm-webform-edit-popup-button-container">
				<button class="webform-small-button webform-small-button-accept crm-webform-edit-popup-button">Ok</button>
			</div>
			-->
		</div>
	</div>
