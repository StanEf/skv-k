...
if (!$bInternal)
{
	...
	$arResult['FILTER'] = array(
		...
		array('id' => 'IS_MY_COMPANY', 'name' => GetMessage('CRM_COLUMN_IS_MY_COMPANY'), 'type' => 'checkbox'),
	...
	$requisite->prepareEntityListFilterFields($arResult['FILTER']);
...
$arImmutableFilters = array(
	...
	'HAS_PHONE', 'HAS_EMAIL', 'IS_MY_COMPANY', 'RQ',
	'SEARCH_CONTENT',
