													...
													<td class="crm-offer-info-right">
														<div class="crm-offer-info-data-wrap"><?
															if($addresFieldType === 'multilinetext'):?>
																<textarea class="bx-crm-edit-text-area" name="<?=htmlspecialcharsEx($addresFieldQualifiedName)?>"><?=htmlspecialcharsbx($addresFieldValue)?></textarea><?
															else:?>
								...
								<div class="crm-offer-info-data-wrap"><?
									if(is_array($itemLocality)):
										...
										if(isset($item['IS_MULTILINE']) && $item['IS_MULTILINE']):
											?><textarea class="bx-crm-edit-text-area" name="<?=htmlspecialcharsEx($itemName)?>"><?=htmlspecialcharsbx($itemValue)?></textarea><?
										else:
