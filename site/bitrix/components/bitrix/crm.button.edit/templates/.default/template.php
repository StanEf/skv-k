...
CJSCore::Init(array('clipboard', 'uploader', 'avatar_editor'));
...
<?
function ShowIntranetButtonItemInterface($item, $context)
{
	if(!$item)
	{
		return;
	...
	<div class="crm-button-edit-channel-lines-container <?=($item['ACTIVE'] == 'Y' ? "crm-button-edit-channel-lines-container-active" : "")?>" data-bx-crm-button-item="<?=$type?>">
		...
		<div class="crm-button-edit-channel-lines-inner-wrapper">
			...
			<div class="crm-button-edit-channel-lines-inner-container">
				...
				<?if ($type == 'openline'):?>
					<div class="crm-button-edit-channel-lines-social-container">
						<div class="crm-button-edit-channel-lines-social-name">
							<?=Loc::getMessage('CRM_BUTTON_EDIT_DETAIL_OPENLINE_CHANNELS')?>:
						</div>
						<div id="<?=$type?>_channels" class="crm-button-edit-channel-lines-social-item-container"></div>
					</div>
				<?endif?>
				<?if ($type == 'callback'):?>
			...
			<div class="crm-button-edit-channel-lines-display-options-container">
				...
				<div data-crm-button-item-settings-wt="<?=$type?>" class="crm-button-edit-channel-lines-display-options-links-container">
					<?ShowIntranetButtonItemWorkTimeInterface($item, $context);?>
				</div>
			</div>
...
function ShowIntranetButtonItemWorkTimeInterface($item, $context)
{
	$workTime = $context->getComponent()->arResult['WORK_TIME'];
	$type = htmlspecialcharsbx($item['TYPE']);
	?>
	<div class="crm-button-edit-channel-lines-display-options-time">
		...
		<div class="crm-button-edit-channel-lines-display-options-time-inner" style="position: relative;" data-crm-button-item-worktime="<?=$type?>">
			<div class="crm-button-edit-channel-lines-display-options-time-shadow" data-crm-wt-shadow=""
				style="<?=($item['WORK_TIME']['ENABLED'] ? 'display: none;' : '')?>"
			></div>
		...
		<?if (!empty($arResult['LANGUAGES']['LIST'])):?>
			<div class="crm-button-edit-sidebar-title">
				<span class="crm-button-edit-sidebar-title-item">
					...
					<span class="crm-button-context-help" data-text="<?=htmlspecialcharsbx(Loc::getMessage("CRM_BUTTON_EDIT_LANG_CHOOSE_TIP"))?>">?</span>
				</span>
			</div>
			<div class="crm-button-edit-sidebar-show-container">
				<div class="crm-button-edit-sidebar-show-inner">
					<span id="CRM_BUTTON_LANGUAGES"
						class="bx-lang-btn <?=htmlspecialcharsbx($arResult['LANGUAGES']['CURRENT'])?>"
					...
					>
						...
						<span class="bx-lang-btn-text" style="position: relative;">
							<span data-langs-text="" style="white-space: nowrap; position: absolute;top: -18px;left: 70px;color: grey;">
							<?=htmlspecialcharsbx($arResult['LANGUAGES']['LIST'][$arResult['LANGUAGES']['CURRENT']])?>
							</span>
						</span>
			...
			<div class="crm-button-edit-channel-field">
				...
				<div class="crm-button-edit-channel-content">
					<div id="WIDGET_CONTAINER">
						<?
						ShowIntranetButtonItemInterface($arResult['BUTTON_ITEM_OPEN_LINE'], $this);
						ShowIntranetButtonItemInterface($arResult['BUTTON_ITEM_CRM_FORM'], $this);
						ShowIntranetButtonItemInterface($arResult['BUTTON_ITEM_CALLBACK'], $this);
						?>
					</div>
				</div><!--crm-button-edit-channel-content-->
			</div><!--crm-button-edit-channel-field-->
